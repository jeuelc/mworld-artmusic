...
$(function(){
  ...
  var zoom7 = new ZoomView('#pol6','#pol7 :first');
});
      ...
      this.OnDragEnd = function(event) {
        ...
        if(position.left < 50 || position.left > 150 || position.top < 220 || position.top > 320) { //balhin na
          if(jid == "pol1") {
			...
			$('div#pol5 > img').css("-webkit-transform", "rotate(-3deg)");
            $('div#pol5').css({'top':'270px', 'left':'80px'});
			$('div#pol6 > img').css("-webkit-transform", "rotate(-3deg)");
            $('div#pol6').css({'top':'270px', 'left':'80px'});
			$('div#pol7 > img').css("-webkit-transform", "rotate(-3deg)");
            $('div#pol7').css({'top':'270px', 'left':'80px'});
            ...
            $('div#pol5').css({'top':'270px', 'left':'100px'});
            $('#pol7').css("z-index", 6);
			$('#pol1').css("z-index", 5);
			$('#pol2').css("z-index", 4);
			$('#pol3').css("z-index", 3);
            ...
            $('div#pol5 > img').css("-webkit-transform", "rotate(5deg)");
            $('div#pol5').css({'top':'290px', 'left':'75px'});
            $('div#pol4 > img').css("-webkit-transform", "rotate(-3deg)");
            $('div#pol4').css({'top':'270px', 'left':'80px'});
			$('div#pol3 > img').css("-webkit-transform", "rotate(-3deg)");
            $('div#pol3').css({'top':'270px', 'left':'80px'});
            ...
            $('div#pol6').css({'top':'270px', 'left':'100px'});
            $('#pol1').css("z-index", 6);
			$('#pol2').css("z-index", 5);
			$('#pol3').css("z-index", 4);
            $('#pol4').css("z-index", 3);
